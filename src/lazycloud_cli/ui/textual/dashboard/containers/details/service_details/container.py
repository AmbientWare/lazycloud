...
from lazycloud_cli.ui.textual.dashboard.containers.details.service_details.pods_table import (
    PodTable,
)
from lazycloud_cli.ui.textual.dashboard.containers.details.service_details.resources_table import (
    ResourcesTable,
)
    ...
    def _render_sections(self, service: ServiceStatus) -> None:
        ...
        if service.resources and (
            ...
            resources_section = SectionContainer(
                f"{Icons.SETTINGS} Resource Configuration"
            )
