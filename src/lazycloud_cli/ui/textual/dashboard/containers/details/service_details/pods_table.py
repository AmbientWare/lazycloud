...
from lazycloud_cli.ui.textual.dashboard.containers.details.service_details.delete_instance_modal import (
    DeleteInstanceModal,
)
from lazycloud_cli.ui.textual.dashboard.containers.details.service_details.logs_modal import (
    LogViewerModal,
)
