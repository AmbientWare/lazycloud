...
from lazycloud_cli.ui.dashboard.containers.details.container import (
    ContentContainer,
    DisplayMode,
)
from lazycloud_cli.ui.dashboard.containers.details.secret_details import (
    SecretDeleted,
    SecretUpdated,
)
