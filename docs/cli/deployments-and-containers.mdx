...
Use these commands to inspect and operate deployments. Keep workload resources
and autoscaler settings in Python so the next deploy applies the configuration
you intend.
