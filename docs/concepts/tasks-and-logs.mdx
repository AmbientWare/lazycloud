...
LazyCloud captures everything your code prints. Print with `flush=True` so lines
appear as they happen. The [task and logs reference](/cli/tasks-and-logs) lists
every command, and the dashboard's Tasks page shows the same history.
