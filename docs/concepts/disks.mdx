...
declared size bills per GiB-month for the time a container holds it. Disks need
a paid plan, which caps the declared size of all disks in a workspace, and a
deploy past the cap fails with a message naming it.
