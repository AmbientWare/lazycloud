...
concurrency, longer log and artifact retention, and a connected AWS account.
Every plan can join its own machines and use every GPU model, given a saved
card, credit, and availability.
