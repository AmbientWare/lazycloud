...
Pick a workflow and download its standalone uv project. Each guide covers
setup, a first run, and cleanup. The source and assets ship with the SDK, so
...
Python setup step for them. Use the CLI storage commands to inspect, download,
and clean up data.
