...
__GPU_SETUP__
__ZRAM_SETUP__
# Durable disks reach their containers through kernel NBD devices. Loaded at
# boot so the worker never needs to load modules, and proved here: without the
# module every disk attach on the node fails.
