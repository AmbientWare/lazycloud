...
- [ ] SDK-44 Exchange data through an exposed TCP port where ingress is configured. PARTIAL: production TCP ingress lacks public DNS, TLS, and listener routing. Local TCP passed. No ingress change shipped in 0.0.97.
