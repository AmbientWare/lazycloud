...
Revision ID: a85cb51401fe
Revises: 
Create Date: 2025-04-06 00:27:51.252875
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_ssh_keys_value'), 'ssh_keys', ['value'], unique=True)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_ssh_keys_value'), table_name='ssh_keys')
