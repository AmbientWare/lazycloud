...
class SchedulerProcessResult:
    ...
    def to_dict(self) -> dict[str, int]:
        return {
            ...
            "private_network_cleanup_processed_count": self.private_network_cleanup_processed_count,
            "private_network_cleanup_completed_count": self.private_network_cleanup_completed_count,
            "private_network_cleanup_failure_count": self.private_network_cleanup_failure_count,
    ...
    with runtime:
        if once:
            ...
            return SchedulerProcessResult(
                ...
                private_network_cleanup_processed_count=(
                    result.private_network_cleanup_processed_count
                ),
                private_network_cleanup_completed_count=(
                    result.private_network_cleanup_completed_count
                ),
                private_network_cleanup_failure_count=(
                    result.private_network_cleanup_failure_count
                ),
            )
