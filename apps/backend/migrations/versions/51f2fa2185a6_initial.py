...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_compose_deployments_cluster_id'), 'compose_deployments', ['cluster_id'], unique=False)
    ...
    sa.Column('cpu_core_seconds', sa.Float(), nullable=False),
    sa.Column('memory_gb_seconds', sa.Float(), nullable=False),
    sa.Column('storage_gb_months', sa.Float(), nullable=False),
    sa.Column('build_minutes', sa.Float(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_compose_deployments_cluster_id'), table_name='compose_deployments')
