...
> = {
  note: {
    icon: Info,
    colors:
      'border-blue-500/50 bg-blue-500/10 text-blue-200 [&_strong]:text-blue-300',
    defaultTitle: 'Note',
  },
  warning: {
    icon: AlertTriangle,
    colors:
      'border-yellow-500/50 bg-yellow-500/10 text-yellow-200 [&_strong]:text-yellow-300',
    defaultTitle: 'Warning',
  },
  tip: {
    icon: Lightbulb,
    colors:
      'border-green-500/50 bg-green-500/10 text-green-200 [&_strong]:text-green-300',
    defaultTitle: 'Tip',
  },
  danger: {
    icon: AlertCircle,
    colors:
      'border-red-500/50 bg-red-500/10 text-red-200 [&_strong]:text-red-300',
    defaultTitle: 'Danger',
  },
}
