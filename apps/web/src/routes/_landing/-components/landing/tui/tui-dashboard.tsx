...
const dashboardFeatures = [
  ...
  },
  {
    ...
    description:
      'Securely manage environment variables and build args from your terminal.',
    icon: IconLock,
    card: SecretsCard,
  },
  {
                  ...
                  <div className="flex items-center border-b border-border/40 bg-muted/40 px-4 py-4">
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center gap-3">
                        <div className="flex size-10 shrink-0 items-center justify-center rounded-lg border border-border/60 bg-lazycloud/10">
