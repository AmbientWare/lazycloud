    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          ...
          https://lazycloud.dev/legal/privacy-policy.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          ...
          . Notices to Customer
          must be sent to the email address tied to Customer&apos;s account.
          Either party may change its email address for receipt of notice by
