...
import { LAZYCLOUD_DOMAIN } from '@/lib/constants'
...
export function RequestAccessEmailTemplate({
  title,
  body,
}: RequestAccessEmailTemplateProps) {
  return (
    <Html>
      <Head />
      <Body
      ...
      >
        ...
        <Text style={{ fontSize: '16px', marginTop: '20px' }}>{body}</Text>
      </Body>
    </Html>
  )
}
