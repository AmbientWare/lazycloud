import { b as requireReact, g as getDefaultExportFromCjs } from "../_chunks/_libs/react.mjs";
...
function requireReactDomServer_bun_production() {
  ...
  if ("19.2.3" !== isomorphicReactPackageVersion$jscomp$inline_821)
    throw Error(
  ...
  reactDomServer_bun_production.version = "19.2.3";
...
function requireServer_bun() {
  if (hasRequiredServer_bun) return server_bun$1;
  ...
  server_bun$1.version = b.version;
  server_bun$1.renderToReadableStream = b.renderToReadableStream;
  server_bun$1.resume = b.resume;
  server_bun$1.renderToString = l.renderToString;
  server_bun$1.renderToStaticMarkup = l.renderToStaticMarkup;
  return server_bun$1;
}
var server_bunExports = /* @__PURE__ */ requireServer_bun();
const ReactDOMServer = /* @__PURE__ */ getDefaultExportFromCjs(server_bunExports);
const server_bun = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
...
function requireServer_edge() {
  ...
  var l;
  {
    b = /* @__PURE__ */ requireReactDomServer_edge_production();
    l = /* @__PURE__ */ requireReactDomServerLegacy_browser_production();
  }
...
var server_edgeExports = /* @__PURE__ */ requireServer_edge();
const server_edge = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null
}, [server_edgeExports]);
export {
  ReactDOMServer as R,
