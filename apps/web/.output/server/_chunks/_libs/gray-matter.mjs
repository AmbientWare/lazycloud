...
import fs from "fs";
import { r as requireSectionMatter } from "../../_libs/section-matter.mjs";
import { r as requireJsYaml } from "./js-yaml.mjs";
import { r as requireStripBomString } from "../../_libs/strip-bom-string.mjs";
import { r as requireKindOf } from "../../_libs/kind-of.mjs";
var engines = { exports: {} };
...
function requireEngines() {
  ...
  (function(module, exports$1) {
    const yaml = /* @__PURE__ */ requireJsYaml();
...
function requireUtils() {
  ...
  hasRequiredUtils = 1;
  (function(exports$12) {
    const stripBom = /* @__PURE__ */ requireStripBomString();
    const typeOf = /* @__PURE__ */ requireKindOf();
...
function requireDefaults() {
  ...
  const engines2 = /* @__PURE__ */ requireEngines();
...
function requireStringify() {
  ...
  const typeOf = /* @__PURE__ */ requireKindOf();
  const getEngine = /* @__PURE__ */ requireEngine();
...
function requireGrayMatter() {
  ...
  const fs$1 = fs;
  const sections = /* @__PURE__ */ requireSectionMatter();
  const defaults2 = /* @__PURE__ */ requireDefaults();
  const stringify2 = /* @__PURE__ */ requireStringify();
  const excerpt2 = /* @__PURE__ */ requireExcerpt();
  const engines2 = /* @__PURE__ */ requireEngines();
  const toFile2 = /* @__PURE__ */ requireToFile();
  ...
  matter2.read = function(filepath, options2) {
    const str2 = fs$1.readFileSync(filepath, "utf8");
...
var grayMatterExports = /* @__PURE__ */ requireGrayMatter();
