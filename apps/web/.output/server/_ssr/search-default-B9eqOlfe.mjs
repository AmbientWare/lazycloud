...
import { ax as useRouter, ay as buttonVariants$1, aw as import__fumadocs_ui_contexts_i18n } from "./router-9CFt_0DZ.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { r as reactExports, j as jsxRuntimeExports } from "../_chunks/_libs/react.mjs";
import { c as cva } from "../_libs/class-variance-authority.mjs";
import { e } from "../_libs/scroll-into-view-if-needed.mjs";
import { a as Dialog, b as DialogOverlay, c as DialogContent, d as DialogTitle } from "../_chunks/_libs/@radix-ui/react-dialog.mjs";
import { S as Search, i as ChevronRight, H as Hash } from "../_libs/lucide-react.mjs";
...
function useDocsSearch(clientOptions, deps) {
  ...
  useOnChange([clientOptions, debouncedValue], () => {
    ...
    async function run() {
      ...
      switch (client.type) {
        case "fetch": {
          const { fetchDocs } = await import("./fetch-B9AxBORJ-CII4epom.mjs");
          return fetchDocs(debouncedValue, client);
        }
        case "algolia": {
          const { searchDocs } = await import("./algolia-IT2aRQE6-Bca7bUT1.mjs");
          return searchDocs(debouncedValue, client);
        }
        case "orama-cloud": {
          const { searchDocs } = await import("./orama-cloud-CiI54EU9-CBqD-rO-.mjs");
          return searchDocs(debouncedValue, client);
        }
        case "orama-cloud-legacy": {
          const { searchDocs } = await import("./orama-cloud-legacy-DG0asrcn-DKQTvFn_.mjs");
          return searchDocs(debouncedValue, client);
        }
        case "mixedbread": {
          const { search: search$1 } = await import("./mixedbread-B4x0e8AJ-BB7Kj4ux.mjs");
          return search$1(debouncedValue, client);
        }
        case "static": {
          const { search: search$1 } = await import("./static-Dg4_dKaf-BC5GgZUm.mjs");
          return search$1(debouncedValue, client);
        }
        default:
