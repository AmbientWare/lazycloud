...
class ContainerService:
    ...
    def _scheduler_request(
        ...
        request = SchedulerWorkerRequest(
            ...
            preferred_worker_id=options.preferred_worker_id,
            preferred_availability_zone=options.preferred_availability_zone,
