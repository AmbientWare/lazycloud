...
def bucket_index(
    ...
    *,
    ...
    Seconds against seconds, rather than an interval between two instants: the
    elapsed span is what both engines compute the same way, where subtracting one
    timestamp column from another is a `- interval` overload on one and string
