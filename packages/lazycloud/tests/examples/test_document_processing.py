...
from lazycloud._examples.document_processing.project.document_processing.api import (
    api as fastapi_app,
)
from lazycloud._examples.document_processing.project.document_processing.resources import (
    MAX_UPLOAD_BYTES,
)
from lazycloud._examples.document_processing.project.document_processing.security import (
    InvalidJobToken,
    issue_job_token,
    verify_job_token,
)
from lazycloud._examples.document_processing.project.document_processing.storage import (
...
from lazycloud._examples.document_processing.project.document_processing.worker import (
    process_document,
)
...
def test_upload_route_distinguishes_type_header_and_size_failures(
    ...
    monkeypatch.setattr(
        "lazycloud._examples.document_processing.project.document_processing.api.DATA_ROOT",
        tmp_path,
    )
...
def test_worker_persists_ocr_output_and_removes_upload_on_success_and_failure(
    ...
    monkeypatch.setattr(
        "lazycloud._examples.document_processing.project.document_processing.worker.subprocess.run",
        fake_run,
    )
