...
Set bucket paths and credentials using https://docs.lazycloud.dev/examples/parallel-parquet-s3.
From the downloaded project directory, create and process four ten-row sample partitions:
